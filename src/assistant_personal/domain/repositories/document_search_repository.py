...
class DocumentSearchRepository(Protocol):
    ...
    Precondición de diseño de bajo costo para la decisión de RAG (§A.10): el dominio actual
    ...
    libre que sí justifique RAG (los 4 criterios de §A.10), baste con un adaptador nuevo —
