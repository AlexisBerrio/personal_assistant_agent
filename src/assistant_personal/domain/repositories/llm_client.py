...
class LLMClient(Protocol):
    ...
    Async de punta a punta. Antes de este port, el SDK de OpenAI se invocaba de forma síncrona
    dentro de un flujo async (`TaskOrchestrator.handle_message_async`), bloqueando el event loop
    entero durante cada llamada de red al LLM. El adaptador de infraestructura (`openai_llm_client.py`) implementa
